...
<div class="py-[4rem] bg-[#0798ca30]">
   ...
   <div class="max-w-screen-xl md:mx-auto  mt-[2rem] md:px-0 px-4">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                ...
                                <div class="w-full">
                                  <span v-if="floating_email===undefined || floating_email===''" :class="[MessageEmail===true ? 'block text-[12px] text-red-500 flex gap-2 items-center': 'hidden']">
                                    ...
                                    <span v-else :class="[MessageValiteEmail!==true ? 'block text-[12px] text-red-500 flex gap-2 items-center': 'hidden']">
                                    <FontAwesomeIcon :icon="faCircleXmark" class="mb-0"/>
                                     Invalid Format of the Email 
                                    </span>
      ...
      <div :class="[breadCrumUrl[1]!=='' ? 'text-xs text-[#646161] md:flex  block md:gap-4 items-center bg-[#0798ca30] p-4 w-full text-left' : 'hidden']">
        <div class="flex gap-2 items-center ">
